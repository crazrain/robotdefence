...
export const HEROES_DATA: HeroData[] = [
  ...
  { id: 5, name: 'Warlock', imageKey: 'Rare3', assetPath: 'assets/images/Rare3.png', fireEffect: 'assets/images/Rare_Effect.png', fireSound: 'assets/sounds/Rare_Sound.mp3', type: 'TypeB', atkInterval: 3.0, attackSpeed: 0.33, range: 210, skills: [{ skillId: 'berserk', level: 1 }] },
  { id: 6, name: 'Archer', imageKey: 'Epic1', assetPath: 'assets/images/Epic1.png', fireEffect: 'assets/images/Epic_Effect.png', fireSound: 'assets/sounds/Epic_Sound.mp3', type: 'TypeC', atkInterval: 1.0, attackSpeed: 1.0, range: 240, skills: [{ skillId: 'berserk', level: 1 }] },
  ...
  { id: 8, name: 'Ranger', imageKey: 'Epic3', assetPath: 'assets/images/Epic3.png', fireEffect: 'assets/images/Epic_Effect.png', fireSound: 'assets/sounds/Epic_Sound.mp3', type: 'TypeC', atkInterval: 3.0, attackSpeed: 0.33, range: 250, skills: [{ skillId: 'berserk', level: 1 }] },
  { id: 9, name: 'Crusader', imageKey: 'Legendary1', assetPath: 'assets/images/Legendary1.png', fireEffect: 'assets/images/Legendary_Effect.png', fireSound: 'assets/sounds/Legendary_Sound.mp3', type: 'TypeD', atkInterval: 1.0, attackSpeed: 1.0, range: 260, skills: [{ skillId: 'berserk', level: 1 }] },
  ...
  { id: 11, name: 'Templar', imageKey: 'Legendary3', assetPath: 'assets/images/Legendary3.png', fireEffect: 'assets/images/Legendary_Effect.png', fireSound: 'assets/sounds/Legendary_Sound.mp3', type: 'TypeD', atkInterval: 3.0, attackSpeed: 0.33, range: 270, skills: [{ skillId: 'berserk', level: 1 }] },
  { id: 12, name: 'Dragon', imageKey: 'Mythical1', assetPath: 'assets/images/Mythical1.png', fireEffect: 'assets/images/Mythical_Effect.png', fireSound: 'assets/sounds/Mythical_Sound.mp3', type: 'TypeE', atkInterval: 1.0, attackSpeed: 1.0, range: 280, skills: [{ skillId: 'berserk', level: 1 }] },
  ...
  { id: 14, name: 'Titan', imageKey: 'Mythical3', assetPath: 'assets/images/Mythical3.png', fireEffect: 'assets/images/Mythical_Effect.png', fireSound: 'assets/sounds/Mythical_Sound.mp3', type: 'TypeE', atkInterval: 3.0, attackSpeed: 0.33, range: 260, skills: [{ skillId: 'berserk', level: 1 }] }
];